...
const BoothShowcase = () => {
  const boothOptions = [
    {
      name: "PicaPica Photobooth",
      description: "Beauty Plus Photobooth özelliklerini keşfedin. Photobooth picapica ile eğlenceli ve renkli fotoğraflar çekin.",
    ...
    {
      name: "Digibooth Kpop",
      description: "K-pop digibooth deneyimi ile idol fotoğrafları çekin. En popüler kpop photo booth platformu.",
      imageSrc: "/lovable-uploads/95c01b04-2c56-4d10-8223-831f4995f862.png",
      gradientFrom: "purple-400",
      gradientTo: "violet-500",
      link: "/kpop-photobooth"
    },
    {
      name: "Vintage Booth",
    ...
    {
      name: "Ideal Photo Booth",
      description: "Digibooth teknolojisi ile modern fotoğraf deneyimi. Profesyonel kalitede sonuçlar.",
